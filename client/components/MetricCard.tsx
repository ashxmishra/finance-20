...
export default function MetricCard({ title, value, accent }: { title: string; value: string | number; accent?: "green" | "red" | "blue" | "amber" }) {
  ...
  return (
    <div className={cn("rounded-xl border bg-card p-4 shadow-sm relative overflow-hidden", `before:absolute before:inset-0 before:bg-gradient-to-br ${acc} before:pointer-events-none`)}>
